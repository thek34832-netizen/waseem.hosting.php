    ...
    <style>
        ...
        * { 
        ...
        .bg-gradient {
            ...
            z-index: -1;
            background: 
                radial-gradient(circle at 15% 90%, rgba(255, 107, 53, 0.05) 0%, transparent 40%),
                radial-gradient(circle at 85% 10%, rgba(6, 182, 212, 0.04) 0%, transparent 40%),
                linear-gradient(180deg, #ffffff 0%, #fbfbfb 100%);
        }

        /* Animated Flame Glow Effect - kept to the corners so text stays crisp */
        .glow-effect {
            position: fixed;
            width: 380px;
            height: 380px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(255, 107, 53, 0.32) 0%, transparent 70%);
            filter: blur(80px);
            z-index: -1;
        ...
        .glow-effect:nth-child(1) {
            top: -190px;
            left: -190px;
            background: radial-gradient(circle, rgba(255, 167, 38, 0.28) 0%, transparent 70%);
            animation-delay: 0s;
        }
        ...
        @keyframes floatGlow {
            ...
            50% {
                transform: translate(25px, -15px) scale(1.18);
                opacity: 0.9;
            }
            100% {
