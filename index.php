...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($file['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($file_ext, $allowed_types)) {
                ...
                if ($file_ext === 'zip') {
                    ...
                    $file_path = SITES_DIR . '/' . $custom_url . '.' . $file_ext;
    ...
    elseif (isset($_POST['html_code'])) {
        ...
        if (!empty($html_code)) {
            ...
            $custom_url = cleanCustomUrl($custom_url);
            $file_path = SITES_DIR . '/' . $custom_url . '.html';
...
function handleZipUpload($zip_tmp, $custom_url) {
    ...
    if ($zip->open($zip_tmp) === TRUE) {
        $extract_path = SITES_DIR . '/' . $custom_url;
        ...
        if ($file !== '.' && $file !== '..') {
            ...
            if (is_dir($file_path)) {
                ...
                if (!empty($html_files)) {
                    ...
                    $gh_deployment = isset($github_deployments[$site_name]) ? $github_deployments[$site_name] : null;
