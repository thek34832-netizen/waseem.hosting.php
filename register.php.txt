...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password !== $confirm) {
        ...
        $result = authRegister($username, $password);
        if ($result['success']) {
...
<title>Sign Up — MR WASEEM HACKER HOSTING</title>
...
<body>
    ...
    <div class="wrap">
        <div class="card">
            ...
            <h1 class="brand-title">WASEEM - HACKER<br>Sign Up - Page</h1>
            <p class="subtitle">Create an account to start hosting your own projects</p>
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <input type="text" name="username" placeholder="Choose a username" autocomplete="username" required autofocus>
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn-unlock">Create Account</button>
            </form>
